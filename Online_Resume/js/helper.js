...
var HTMLskillsStart = '<h3 id="skillsH3">Skills at a Glance:</h3><ul id="skills" class="flex-box skills-display"></ul>';
...
var HTMLonlineClasses = '<h3 class= "olClasses">Online Classes</h3>';
...
function initializeMap() {
  ...
  */
  function locationFinder() {
    ...
    //alert("ABBA"+" "+bio.contactInfo.location+" "+work.jobs[job].location)+" "+education.schools[school].location);
