...
$(function() {
    ...
    */
    ...
    describe('Initial Entries', function() {
        ...
        //Checks whether the number of articles loaded are greater than zero or not.
        it('should have minimum of one entry in feed', function(done) {
            var numEntry = $('.entry').length;
